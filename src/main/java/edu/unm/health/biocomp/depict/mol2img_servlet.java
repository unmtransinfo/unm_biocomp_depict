...
public class mol2img_servlet extends HttpServlet
{
	...
	throws ServletException, IOException
  {
    ...
    LicenseManager.refresh(); //Necessary?
    ...
    {
      try { mol2img_utils.ColorBySmarts(mol, smartslist, smilesmatch); } catch (Exception e) { System.err.println(e.getMessage()); } //depict anyway
      imgfmt+=",setcolors:a0:black:b0:black:b1:red:a1:red:b2:red"; //required after JChem5_2_0:
    }
    else if (qmol!=null)
    {
      try { mol2img_utils.ColorByQMol(mol, qmol); } catch (Exception e) { System.err.println(e.getMessage()); } //depict anyway
      imgfmt+=",setcolors:a0:black:b0:black:b1:red:a1:red:b2:red"; //required after JChem5_2_0:
    }
